        ...
        "items": [
            {
                ...
                "type_line": "Wand",
                "rarity": 2,
                "mods": ["+6 to Level of all Fire Spell Skills"],
            },
            {
                "slot": "Offhand",
                "weapon_set": 1,
                "name": "The Dark Defiler",
                "type_line": "Rattling Sceptre",
                "rarity": 3,
                "mods": ["15% increased Spirit"],
            },
            {
                "slot": "Weapon 1 Swap",
                "weapon_set": 2,
                ...
                "type_line": "Staff",
                "rarity": 3,
                "mods": ["195% increased Chaos Damage", "+86 to Spirit"],
            },
            {
                "slot": "BodyArmour",
                "weapon_set": None,
                "name": "Necromantle",
                "type_line": "Conjurer Mantle",
                "rarity": 2,
                "mods": ["+55 to maximum Life"],
            },
        ],
    }
...
def test_swap_weapon_in_separate_section(mcp):
    text = mcp._format_character_analysis(
        _char(), analysis={}, recommendations="", passive_analysis=None
    )
...
def test_no_swap_section_for_single_set(mcp):
    ...
    text = mcp._format_character_analysis(
        char, analysis={}, recommendations="", passive_analysis=None
    )

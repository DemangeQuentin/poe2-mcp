...
class TestCharacterAnalyzerDefenses:
    ...
    def test_analyze_defenses_field_name_fallbacks(self):
        ...
        char_data_res = {
            "level": 50,
            "raw_data": {"charModel": {"defensiveStats": {"life": 1000, "fireRes": 50}}},
        }
        result = self.analyzer._analyze_defenses(char_data_res)
        assert result["resistances"]["fire"] == 50

        # Test with fireResistance format
        char_data_resistance = {"level": 50, "stats": {"life": 1000, "fireResistance": 60}}
    ...
    def test_level_scaled_ehp_thresholds(self):
        ...
        char_level_10_weak = {"level": 10, "stats": {"life": 400, "energyShield": 100}}
        ...
        char_level_10_good = {"level": 10, "stats": {"life": 1000, "energyShield": 100}}
        ...
        char_level_50 = {"level": 50, "stats": {"life": 1500, "energyShield": 0}}
        ...
        char_level_50_weak = {"level": 50, "stats": {"life": 3000, "energyShield": 0}}
        ...
        char_level_50_good = {"level": 50, "stats": {"life": 5000, "energyShield": 500}}
...
class TestGearRecommender:
    ...
    def test_recommend_resistance_upgrades(self):
        ...
        analysis = {
            "defensive_analysis": {
                "effective_hp": 6000,
                "resistances": {"fire": 40, "cold": 75, "lightning": 75, "chaos": 0},  # Below 75
            }
        }
